...
var MailRepository = /** @class */ (function () {
    ...
    MailRepository.prototype.updateFinishedAt = function (mailId, finishedAt) {
        return __awaiter(this, void 0, void 0, function () {
            var mailIndex;
            return __generator(this, function (_a) {
                mailIndex = MailRepository.MAILS.findIndex(function (item) { return item.id === mailId; });
                MailRepository.MAILS[mailIndex].finishedAt = finishedAt;
                return [2 /*return*/];
            });
        });
    };
    MailRepository.prototype.insert = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var newMail;
            return __generator(this, function (_a) {
                newMail = {
